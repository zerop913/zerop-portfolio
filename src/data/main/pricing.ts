...
export const pricingData: PricingTier[] = [
  ...
  },
  {
    id: "maintenance",
    title: {
      ru: "Разработка БД и API",
      en: "Database & API Development",
    },
    description: {
      ru: "Проектирование баз данных и разработка API для ваших проектов",
    ...
    features: {
      ...
      en: [
        ...
        "Index setup and optimization",
        "API documentation",
        "Authentication setup",
        "Frontend integration",
      ],
    },
    technologies: ["PostgreSQL", "MongoDB", "FastAPI", "Node.js", "Express"],
    timeline: {
      ru: "2-4 недели",
      en: "2-4 weeks",
    },
